...
(function (Scratch) {
    ...
    if ((!Scratch.vm.extensionManager.isExtensionLoaded("penP"))){ //&& Scratch.extensions.isPenguinMod) {
        ...
        Scratch.vm.extensionManager.loadExtensionURL("http://localhost:8000/extensions/PenP/v7.js");
    }
    ...
    class extension {
        ...
        _meshImporter() {
            ...
            const updateOptions = () => {
                ...
                //Import Handler
                if (this[`_import_handle_${split[split.length - 1].toLowerCase()}`]) this[`_import_handle_${split[split.length - 1].toLowerCase()}`](shaderPanel, closeFunc);
            }
