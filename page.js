            ...
            <div class="extension-buttons">
                ${(function () {
                  ...
                  if (extensionJSON.turbowarpVersion) {
                    bodyData += `<a id="${extensionJSON.id}_open_TWVER" style="background-color:#ff4c4c" href="https://turbowarp.org/editor?extension=${extensionJSON.turbowarpVersion}">Open Turbowarp Version</a>`;
                  }
